...
class MockClass(serde.JsonSerdeMixin):
...
class TestJsonSerdeMixin:
    ...
    def test_to_json_with_meta(self):
        ...
        test_json = test_class.to_json(row_metadata=True, column_metadata=True)
        exp_json = json.dumps({
            'name': self.name,
            'data': self.sequences,
            'comments': self.comments,
    ...
    def test_to_dict_row_meta(self):
        ...
        test_json = test_class.to_json(row_metadata=True, column_metadata=False)
        exp_json = json.dumps({
            'name': self.name,
            'data': self.sequences,
            'comments': self.comments,
    ...
    def test_to_dict_col_meta(self):
        ...
        test_json = test_class.to_json(row_metadata=False, column_metadata=True)
        exp_json = json.dumps({
            'name': self.name,
            'data': self.sequences,
            'comments': self.comments,
    ...
    def test_from_json(self):
        ...
        with tempfile.TemporaryFile(mode='r+') as f:
            f.write(exp_json)
            f.seek(0)
            test_class = MockClass.from_json(f)
